...
public class ZeeTamilParser {
    public static ArrayList<Entry> parseResponse(String response, Context context){
        ...
        for (int i = 0; i < nl.getLength(); i++) {
            ...
            tamilHinduEntries.add(new Entry(title, Subscription.ZEE_TAMIL.name,content,thumbNailURL,timestamp,contentURL,
                    Subscription.ZEE_TAMIL.iconID));
        }
